...
function tieronetwo_next_prev_link()
{
    ...
    <div class="row flex-fallback">
        ...
        <?php if ( $next_post ) : ?>
        <div class="col-lg-6 <?php echo ( $prev_post ? '' : 'col-lg-offset-l6' ); ?> col-md-12 col-sm-12">
            <div class="thumbnail">
                <div class="content">
...
function _featured_image(){?>
    <figure class="figure text-center" itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
        ...
        <a href="<?php the_permalink(); ?>">
            <img class="img-responsive" src="<?php echo $file; ?>" onerror="javascript:this.src='<?php echo get_template_directory_uri() . "/images/default.jpg"; ?>'" itemprop="contentUrl">
        </a>
    </figure>
<?php
}
